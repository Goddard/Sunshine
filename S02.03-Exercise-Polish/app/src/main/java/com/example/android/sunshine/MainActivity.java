...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView eMessageDisplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eMessageDisplay = (TextView) findViewById(R.id.error_display);
    ...
    {
        eMessageDisplay.setVisibility(View.INVISIBLE);
    ...
    {
        eMessageDisplay.setVisibility(View.VISIBLE);
