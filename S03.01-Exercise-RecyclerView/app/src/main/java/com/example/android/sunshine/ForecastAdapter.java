...
/**
 * Created by irenicus on 1/14/18.
 */
...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    @Override
    public ForecastAdapterViewHolder onCreateViewHolder(ViewGroup vGroup, int index)
    {
...
//        boolean shouldAttachToParentImmediately = false;
        ...
        View view = inflater.inflate(layoutIdForListItem, vGroup, false);
    ...
    @Override
    public void onBindViewHolder(ForecastAdapterViewHolder vHolder, int position)
    {
        String weatherForThisDay = mWeatherData[position];
        vHolder.mWeatherTextView.setText(weatherForThisDay);
    }
