...
//  COMPLETED (18) Create a String array containing the names of the desired data columns from our ContentProvider3
...
//  COMPLETED (20) Create a constant int to identify our loader used in DetailActivity
    ...
    public static final int DETAIL_LOADER_ID = 999;
...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mHigh = (TextView) findViewById(R.id.tv_high_temprature);
        mLow = (TextView) findViewById(R.id.tv_low_temprature);
        mHumidity = (TextView) findViewById(R.id.tv_humidity);
        mWind = (TextView) findViewById(R.id.tv_wind_speed);
